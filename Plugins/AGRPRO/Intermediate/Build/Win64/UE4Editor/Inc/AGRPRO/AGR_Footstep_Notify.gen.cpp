...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_FootKey_MetaData[];
#endif
		static const UE4CodeGen_Private::FNamePropertyParams NewProp_FootKey;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAGR_Footstep_Notify_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAGR_Footstep_Notify_Statics::NewProp_FootKey_MetaData[] = {
		{ "Category", "AGR" },
		{ "ExposeOnSpawn", "TRUE" },
		{ "ModuleRelativePath", "Public/Data/AGR_Footstep_Notify.h" },
	};
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_UAGR_Footstep_Notify_Statics::NewProp_FootKey = { "FootKey", nullptr, (EPropertyFlags)0x0011000000000015, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAGR_Footstep_Notify, FootKey), METADATA_PARAMS(Z_Construct_UClass_UAGR_Footstep_Notify_Statics::NewProp_FootKey_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAGR_Footstep_Notify_Statics::NewProp_FootKey_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAGR_Footstep_Notify_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAGR_Footstep_Notify_Statics::NewProp_FootKey,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UAGR_Footstep_Notify_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UAGR_Footstep_Notify()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UAGR_Footstep_Notify_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UAGR_Footstep_Notify, 4184192669);
